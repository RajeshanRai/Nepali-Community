...
class DonationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'donor_phone': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Phone number'}),
            'donor_address_line1': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Street address'}),
            'donor_city': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'City'}),
            'donor_province': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Province/State'}),
            'donor_postal_code': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Postal code'}),
